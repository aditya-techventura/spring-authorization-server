...
public class JettyServerConfig {
	...
	@Bean
	public WebServerFactoryCustomizer<JettyServletWebServerFactory> jettyServerFactoryCustomizer(SSLContext serverSslContext) {
		return (factory) -> {
			JettyServerCustomizer jettyServerCustomizer = server -> {
				SslContextFactory.Server sslContextFactory = new SslContextFactory.Server();
				sslContextFactory.setSslContext(serverSslContext);
